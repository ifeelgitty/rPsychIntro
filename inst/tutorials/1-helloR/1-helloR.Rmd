...
quiz(caption="Conditional Statements",
  question("If you either get 2 out of the following three questions correct, or you are a rebel, you can continue with the next quiz. Which logical statement reflects this?",
    answer("``"),
    answer("`as.string(55)`", message = "Don't forget that R does not call Strings Strings, urgh."),
    answer("`n_correct > 2 `", correct = TRUE),
    answer("`55.toString()`"),
    allow_retry = T
  ),
