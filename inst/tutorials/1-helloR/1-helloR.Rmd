...
Finally, it is also possible to put an if statement into another if statement, called a nested if-statement! 

```{r ifStatement4, exercise=TRUE, exercise.eval=TRUE, include=FALSE}
my_height <- 184
my_haircolor <- "blonde"
me_being_rich <- FALSE
...
*This is where a short summary of the learned stuff in the video will be placed, in case you're a bit sloooow, or just don't like all of the stuff going on in videos, colors, movement and other fancy 21st century things to try to get those ADHD kids to focus for more than 30 seconds!*
...
```{r veclists, exercise=TRUE, exercise.eval=TRUE, include=FALSE}
...
The term retrieves its own list, a list of booleans in the same order as the `invitees`-list. 
...
knitr::include_graphics("images/hellundgrau.png")
```